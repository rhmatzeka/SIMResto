// Fungsi untuk menampilkan/menyembunyikan deskripsi item menu
      ...
      function proceedToCheckout() {
        ...
        if (orderData.length > 0) {
          ...
          window.location.href = "chackout.html"; // PERHATIKAN: Anda mungkin salah ketik, biasanya "checkout.html"
        } else {
      ...
      // Fungsi Dark Mode (pastikan ini ada jika Anda memiliki tombolnya)
      ...
      // Panggil feather icons setelah DOM siap
      document.addEventListener("DOMContentLoaded", () => {
        ...
        // Inisialisasi tampilan checkout (penting jika halaman di-refresh atau ada item tersimpan)
        updateCheckout();
      });