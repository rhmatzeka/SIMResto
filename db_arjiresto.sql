...
--
-- Host: localhost:3306
-- Generation Time: Nov 30, 2025 at 01:55 PM
...
(8, 'RAHMATGANZ', 'DISKON DADAKAN', 'persen', '20.00', '691320dda7957-good_quality_19.jpg', 'aktif', '2025-11-11 18:40:00', '2025-12-30 18:40:00');
...
(7, 1, 3, NULL, '2025-12-02 20:21:11', '0.00', '17.30', '', NULL, NULL, 'paid'),
(22, 22, 5, 'Rahmat eka', '2025-12-10 18:56:07', '20.00', '300000.00', 'Cash', 'test', '10000.00', 'Berhasil'),
(26, 1, NULL, NULL, '2025-06-01 22:26:22', '0.00', '116.00', 'Bank Transfer', NULL, NULL, 'Pending'),
(56, 21, 2, 'Rahmat', '2025-11-30 20:02:01', '0.00', '32.40', '0', NULL, NULL, 'pending'),
(57, 21, 4, 'agung', '2025-11-30 20:02:36', '0.00', '51.60', '0', NULL, NULL, 'pending');
...
(85, 56, 'Croissant', 13, 3, '5.40', '16.20', 'Pending'),
(86, 56, 'Cinnamon Roll', 15, 3, '5.40', '16.20', 'Pending'),
(87, 57, 'Americano', 20, 3, '7.50', '22.50', 'Pending'),
(88, 57, 'Spinach and Artichoke Dip', 5, 3, '9.70', '29.10', 'Pending');
...
(22, 57, 'finished', '2025-11-30 11:59:34');
...
CREATE TABLE `reservations` (
  ...
  `table_number` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(15, 'user', 'user@gmail.com', '2025-11-11 18:15:00', 3, '3', 'saya pesan meja 3', 'Pending', NULL, '2025-11-11 11:16:12'),
(16, 'user', 'user@user', '2025-11-28 20:48:00', 5, '5', 'deket jendela', 'Pending', NULL, '2025-11-28 13:48:56'),
(17, 'user', 'user@user', '2025-12-02 20:03:00', 5, '3', 'dekat jendela ya', 'Pending', NULL, '2025-11-30 13:03:40');
...
CREATE TABLE `tables` (
  ...
  `status` enum('available','reserved') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'available'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(16, 'admin', 'admin@admin', '$2y$10$N98tNAGM8TxHi6rTpJvDOeV5cGGeqZx0yaW2kdM92eDtnic6sDt/u', '089514509392', '2025-11-03 15:25:17', 'admin', 'LP-2025-0016', NULL),
(17, 'user', 'user@user', '$2y$10$hgjZkqTpQc5qmdzvTFofK.43t7wTTmlxTMulz.KZ9.SSQfGEaHE2i', '089555555555', '2025-11-03 15:33:17', 'user', 'LP-2025-0017', NULL),
...
(22, 'test', 'test@test', '$2y$10$gmKHzqAL/bmhdJmXOjgHYO7FQHdoslFokdymBND7RJPhwdao1uyj2', '09876', '2025-11-30 11:55:52', 'user', 'LP-2025-0022', NULL);
