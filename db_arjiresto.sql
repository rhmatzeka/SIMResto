...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2025 at 08:39 PM
...
(56, 23, NULL, NULL, '2025-11-30 20:35:47', 0.00, 566.00, '', NULL, NULL, 'pending'),
(57, 23, NULL, NULL, '2025-11-30 20:37:01', 0.00, 566.00, '', NULL, NULL, 'pending'),
(58, 23, NULL, NULL, '2025-11-30 20:38:33', 0.00, 566.00, '', NULL, NULL, 'pending');
...
CREATE TABLE `reservations` (
  ...
  `status` enum('Pending','Confirmed','Cancelled','Seated','No Show') NOT NULL DEFAULT 'Pending',
...
(22, 'admin', 'admin@admin', '$2y$10$OgB6Zy/YgwYtaSAF5qt.b.XUfSI1kjb11gfuIXl/L.7Hsazo4UpNa', '09876543', '2025-11-19 17:27:08', 'admin', 'LP-2025-0022', NULL),
(23, 'user', 'user@user', '$2y$10$GkbTHtbk0M/Ft3odGxiAw.mzL/OUkZtU.JLD0yj19eNpOHU5BPvqy', '09876543', '2025-11-19 17:28:35', 'user', 'LP-2025-0023', NULL);
